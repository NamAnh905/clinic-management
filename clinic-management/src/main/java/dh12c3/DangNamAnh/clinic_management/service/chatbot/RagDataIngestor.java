...
public class RagDataIngestor {
    ...
    public void ingestAllData() {
        ...
        List<DrugResponse> drugs = drugPage.getData();
        ...
        List<KnowledgeResponse> kbs = knowledgeService.findAll();
    ...
    private void embedAndStore(String text, Metadata metadata) {
        ...
        Long entityId = Long.valueOf(metadata.getString("id"));
        vectorSyncService.saveVectorId(type, entityId, qdrantId);
    }
}